;(function($){
    $(document).ready(function(){
        ...
        $('#bf-number-section').on('submit', function(e){
            ...
            $.ajax({
                url: brainforward_login_obj.ajax_url,
                type: 'POST',
                dataType: 'json',
                data: {
                    action: 'brainforward_send_otp',
                    nonce: brainforward_login_obj.nonce,
                    mobile_no: mobile
                },
                beforeSend: function(){
        ...
        $('#bf-forgot-button').on('click', function(e){
            ...
            $.ajax({
                ...
                dataType: 'json',
                data: {
                    action: 'brainforward_forgot_password',
                    nonce: brainforward_login_obj.nonce,
                    mobile_no: mobile
                },
                beforeSend: function(){
        ...
        $('#bf-otp-section').on('submit', function(e){
            ...
            $.ajax({
                ...
                dataType: 'json',
                data: {
                    action: 'brainforward_verify_otp',
                    nonce: brainforward_login_obj.nonce,
                    mobile: mobile,
                    otp: otp
                },
        ...
        $('#bf-password-section').on('submit', function(e){
            ...
            $.ajax({
                ...
                dataType: 'json',
                data: {
                    action: 'brainforward_password_login',
                    nonce: brainforward_login_obj.nonce,
                    mobile: mobile,
                    password: password
                },
