...
$read_more_text = get_theme_mod('blog_read_more_text', __('Read More', 'brainforward'));
?>
...
<div <?php post_class(['post-card', 'post-card--' . get_post_type()]); ?>>
    ...
    <?php if ($image !== 'hide') : ?>
        <div class="post-card__thumbnail">
            <?php Brainforward_Functions::post_thumbnail($image_size); ?>
        </div>
    <?php endif; ?>
    ...
    <div class="post-card__content">
        ...
        <?php if (
            ...
            ($date !== 'hide' && Brainforward_Functions::get_post_date()) ||
            ($comment !== 'hide' && Brainforward_Functions::get_comment_count()) ||
            ($tags !== 'hide' && has_tag()) ||
