                    ...
                    <div class="cart__product">
                        <div class="product-remove">
                            ...
                            echo apply_filters(
                                ...
                                sprintf(
                                    '<a href="%s" class="remove remove_from_cart_button" aria-label="%s" data-product_id="%s" data-cart_item_key="%s" data-product_sku="%s"><i class="ri-close-large-line"></i></a>',
...
<?php else : ?>
    <div class="cart_body">
        <div class="woocommerce-message woocommerce-info woocommerce-mini-cart__empty-message my-5" role="alert">
            <?php esc_html_e( 'No products in the cart.', 'brainforward' ); ?>
        </div>
    </div>
<?php endif; ?>
