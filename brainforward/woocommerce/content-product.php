...
$get_col = ( is_active_sidebar( 'woocommerce_sidebar' ) ? wc_get_loop_prop('columns') - 1: wc_get_loop_prop('columns') );
switch ($get_col) {
    case 1:
        $column = 'col-xs-6 col-12';
        break;
    case 2:
    ...
    case 3:
        ...
        break;
    case 4:
        $column = 'col-xs-6 col-sm-4 col-lg-3';
        break;
    default:
		$column = 'col-xs-6 col-sm-6 col-md-4';
        break;
