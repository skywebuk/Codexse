...
if ( '0' === $comment->comment_approved ) : ?>
	<div class="meta">
		<em class="woocommerce-review__awaiting-approval">
			<?php esc_html_e( 'Your review is awaiting approval', 'brainforward' ); ?>
		</em>
	</div>
<?php else: ?>
	<div class="meta">
		...
		<?php
			if ( 'yes' === get_option( 'woocommerce_review_rating_verification_label' ) && $verified ) {
				echo '<em class="woocommerce-review__verified verified">(' . esc_attr__( 'verified owner', 'brainforward' ) . ')</em> ';
			}
		?>
