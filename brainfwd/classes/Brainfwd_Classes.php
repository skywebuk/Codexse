...
class Brainfwd_Menu_Walker extends Walker_Nav_Menu {
    ...
    function start_el(&$output, $item, $depth = 0, $args = array(), $id = 0) {
        ...
        if (Brainfwd_Setup::detect_homepage() == true) {
...
if (class_exists('WP_Customize_Control')) {
    ...
    class Brainfwd_Radio_Image_Control extends WP_Customize_Control {
 ...
 */
if (!function_exists('brainfwd_mainmenu_demo_content')) {
    function brainfwd_mainmenu_demo_content() {
        ?>
        <ul class="nav">
            <li class="nav-item">
                <a href="<?php echo esc_url(home_url('/')); ?>" class="nav-link"><?php esc_html_e('Home', 'brainfwd'); ?></a>
            </li>
            <?php if (current_user_can('edit_theme_options')) : ?>
                <li class="nav-item">
                    <a href="<?php echo esc_url(admin_url('nav-menus.php')); ?>" class="nav-link"><?php esc_html_e('Add Menu', 'brainfwd'); ?></a>
                </li>
            <?php endif; ?>
        </ul>
        <?php
