...
$label = ! empty( $args['product_name'] ) 
    ? sprintf( esc_html__( '%s quantity', 'brainfwd' ), wp_strip_all_tags( $args['product_name'] ) ) 
    : esc_html__( 'Quantity', 'brainfwd' );
...
<div class="quantity">
    ...
    <input
        ...
        aria-label="<?php esc_attr_e( 'Product quantity', 'brainfwd' ); ?>"
        size="4"
